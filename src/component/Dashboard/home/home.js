...
function Home() {
    ...
    return (
        <div className="home">
            ...
            {/* Marquee for food information */}
            <marquee behavior="scroll" direction="left" style={{ background: '#f8f9fa', padding: '10px', fontSize: '40px', fontWeight: 'bold' }}>
                Discover delicious recipes and the best food from around the world!
            </marquee>
