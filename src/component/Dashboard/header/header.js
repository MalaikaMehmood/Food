...
function Header(){
    ...
    return(
        <div className="header">
            ...
            <button className="cart-button"  ><p style={{color:"white",marginTop:'12px'}} onClick={Logout}>Logout</p></button> 
            <button className="cart-button"  ><p style={{color:"white",marginTop:'12px'}} onClick={FoodList}>FoodList</p></button>   
        </div>
    )
}
